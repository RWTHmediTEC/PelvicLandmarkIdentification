...
%VOLUMEINTEGRATE polyhedron volume, center of mass and inertia matrix
%
...
%
% this function calculates the volume from an assumed closed surface mesh 
% defined by Triangles and Positions (Nodepositions). The Triangles list 
% must have a counterclockwise numbering to ensure the outward normal.
%
% /*******************************************************
...
for i = 1:length(Triangles)
    ...
    if (nx==0)&&(ny==0)&&(nz==0)
        ...
        w = ...
            - Normals(i,1)*Xn(Triangles(i,1),1) ...
            - Normals(i,2)*Xn(Triangles(i,1),2) ...
            - Normals(i,3)*Xn(Triangles(i,1),3);
